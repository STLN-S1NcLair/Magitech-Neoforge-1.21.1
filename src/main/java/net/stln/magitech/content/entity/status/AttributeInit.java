...
public class AttributeInit {
    ...
    public static final DeferredHolder<Attribute, Attribute> MANA_SPELL_POWER = ATTRIBUTES.register("mana_spell_power", () -> (new PercentageAttribute("attribute.magitech.mana_spell_power", 1, 0, Double.MAX_VALUE).setSyncable(true)));
    ...
    public static final DeferredHolder<Attribute, Attribute> LOGOS_SPELL_POWER = ATTRIBUTES.register("logos_spell_power", () -> (new PercentageAttribute("attribute.magitech.logos_spell_power", 1, 0, Double.MAX_VALUE).setSyncable(true)));
