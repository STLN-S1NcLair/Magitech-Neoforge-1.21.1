package net.stln.magitech.content.entity;
...
import net.stln.magitech.content.entity.magicentity.electroide.ElectroideRenderer;
import net.stln.magitech.content.entity.magicentity.frigala.FrigalaEntity;
import net.stln.magitech.content.entity.magicentity.frigala.FrigalaRenderer;
import net.stln.magitech.content.entity.magicentity.frosblast.FrosblastEntity;
import net.stln.magitech.content.entity.magicentity.frosblast.FrosblastRenderer;
import net.stln.magitech.content.entity.magicentity.hexflare.HexflareEntity;
import net.stln.magitech.content.entity.magicentity.hexflare.HexflareRenderer;
import net.stln.magitech.content.entity.magicentity.hydrelux.HydreluxEntity;
import net.stln.magitech.content.entity.magicentity.hydrelux.HydreluxRenderer;
import net.stln.magitech.content.entity.magicentity.ignisca.IgniscaEntity;
import net.stln.magitech.content.entity.magicentity.ignisca.IgniscaRenderer;
import net.stln.magitech.content.entity.magicentity.illusflare.IllusflareEntity;
import net.stln.magitech.content.entity.magicentity.illusflare.IllusflareRenderer;
import net.stln.magitech.content.entity.magicentity.mirazien.MirazienEntity;
import net.stln.magitech.content.entity.magicentity.mirazien.MirazienRenderer;
import net.stln.magitech.content.entity.magicentity.nihilflare.NihilflareEntity;
import net.stln.magitech.content.entity.magicentity.nihilflare.NihilflareRenderer;
import net.stln.magitech.content.entity.magicentity.nullixis.NullixisEntity;
import net.stln.magitech.content.entity.magicentity.nullixis.NullixisRenderer;
import net.stln.magitech.content.entity.magicentity.shockvane.ShockvaneEntity;
import net.stln.magitech.content.entity.magicentity.shockvane.ShockvaneRenderer;
import net.stln.magitech.content.entity.magicentity.tremivox.TremivoxEntity;
import net.stln.magitech.content.entity.magicentity.tremivox.TremivoxRenderer;
import net.stln.magitech.content.entity.magicentity.volkarin.VolkarinEntity;
import net.stln.magitech.content.entity.magicentity.volkarin.VolkarinRenderer;
