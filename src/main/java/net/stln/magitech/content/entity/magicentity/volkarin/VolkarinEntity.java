...
import net.stln.magitech.vfx.particle.particle_option.AbstractCustomizableParticleEffect;
import net.stln.magitech.vfx.particle.particle_option.FlameParticleEffect;
import net.stln.magitech.vfx.particle.particle_option.FlameSmokeParticleEffect;
    ...
    protected void addHitEffect() {
        ...
        if (world.isClientSide) {
            ...
            for (int i = 0; i < hitParticleAmount; i++) {
                ...
                world.addParticle(new FlameParticleEffect(fromColor, toColor, scale1, twinkle, rotSpeed, level().random.nextInt(5, 8), 0.9F), x, y, z, vx, vy, vz);
            }
