...
public class BlockRendererInit {
    ...
    public static void registerBlockEntityRenderer(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerBlockEntityRenderer(BlockInit.INFUSER_ENTITY.get(), InfuserBlockEntityRenderer::new);
        ...
        event.registerBlockEntityRenderer(BlockInit.ENVIROMETER_ENTITY.get(), EnvirometerBlockEntityRenderer::new);
    }
