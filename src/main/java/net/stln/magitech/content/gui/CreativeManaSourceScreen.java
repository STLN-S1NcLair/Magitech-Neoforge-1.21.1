...
@OnlyIn(Dist.CLIENT)
public class CreativeManaSourceScreen extends ManaContainerScreen<CreativeManaSourceMenu> {

    public CreativeManaSourceScreen(CreativeManaSourceMenu menu, Inventory playerInventory, Component title) {
