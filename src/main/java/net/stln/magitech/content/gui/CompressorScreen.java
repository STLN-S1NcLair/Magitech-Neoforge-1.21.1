...
@OnlyIn(Dist.CLIENT)
public class CompressorScreen extends ManaContainerScreen<CompressorMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        float progressRatio = (progress + (progress == 0 ? 0 : partialTick)) / CompressorBlockEntity.MAX_PROGRESS;
    ...
    protected ResourceLocation getBgTexture() {
        return Magitech.id("textures/gui/compressor.png");
    }
}
