...
@OnlyIn(Dist.CLIENT)
public class CreativeManaSinkScreen extends ManaContainerScreen<CreativeManaSinkMenu> {

    public CreativeManaSinkScreen(CreativeManaSinkMenu menu, Inventory playerInventory, Component title) {
