...
@OnlyIn(Dist.CLIENT)
public class EnhancedManaVesselScreen extends ManaContainerScreen<EnhancedManaVesselMenu> {

    public EnhancedManaVesselScreen(EnhancedManaVesselMenu menu, Inventory playerInventory, Component title) {
