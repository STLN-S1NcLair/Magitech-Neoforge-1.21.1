...
//        });
    ...
    public boolean isCorrectMaterialForUpgrade(ItemStack itemStack) {
        return ToolMaterialHelper.isCorrectMaterialForUpgrade(ComponentHelper.getTier(itemStack), ComponentHelper.getUpgradePoint(itemStack), container.getItem(1).getItem());
    }
    ...
    public @NotNull ItemStack quickMoveStack(@NotNull Player player, int index) {
        ...
        if (slot.hasItem()) {
            ...
            if (index == 1) {
                ...
                ItemStack itemStack = this.container.getItem(0);
                if (this.hasUpgradePoint(itemStack) && ToolMaterialHelper.isCorrectMaterialForUpgrade(ComponentHelper.getTier(itemStack), ComponentHelper.getUpgradePoint(itemStack), itemstack1.getItem())) {
