...
import net.stln.magitech.content.item.tool.toolitem.PartToolGenerator;
...
public class CreativeTabInit {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MAGITECH_TOOL_TAB = CREATIVE_MODE_TABS.register("magitech_tool_tab", () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                output.accept(PartToolGenerator.generateDagger(MaterialInit.ZINC));
                output.accept(PartToolGenerator.generateDagger(MaterialInit.BONE));
                output.accept(PartToolGenerator.generateDagger(MaterialInit.GLASS));
                output.accept(PartToolGenerator.generateDagger(MaterialInit.SANDSTONE));
                ...
                output.accept(PartToolGenerator.generateDagger(MaterialInit.TOURMALINE));
                ...
                output.accept(PartToolGenerator.generateDagger(MaterialInit.SULFURIC_ACID_BATTERY));
                ...
                output.accept(PartToolGenerator.generateLightSword(MaterialInit.ZINC));
                output.accept(PartToolGenerator.generateLightSword(MaterialInit.BONE));
                output.accept(PartToolGenerator.generateLightSword(MaterialInit.GLASS));
                output.accept(PartToolGenerator.generateLightSword(MaterialInit.SANDSTONE));
                ...
                output.accept(PartToolGenerator.generateLightSword(MaterialInit.TOURMALINE));
                ...
                output.accept(PartToolGenerator.generateLightSword(MaterialInit.SULFURIC_ACID_BATTERY));
                ...
                output.accept(PartToolGenerator.generateHeavySword(MaterialInit.ZINC));
                output.accept(PartToolGenerator.generateHeavySword(MaterialInit.BONE));
                output.accept(PartToolGenerator.generateHeavySword(MaterialInit.GLASS));
                output.accept(PartToolGenerator.generateHeavySword(MaterialInit.SANDSTONE));
                ...
                output.accept(PartToolGenerator.generateHeavySword(MaterialInit.TOURMALINE));
                ...
                output.accept(PartToolGenerator.generateHeavySword(MaterialInit.SULFURIC_ACID_BATTERY));
                ...
                output.accept(PartToolGenerator.generatePickaxe(MaterialInit.ZINC));
                output.accept(PartToolGenerator.generatePickaxe(MaterialInit.BONE));
                output.accept(PartToolGenerator.generatePickaxe(MaterialInit.GLASS));
                output.accept(PartToolGenerator.generatePickaxe(MaterialInit.SANDSTONE));
                ...
                output.accept(PartToolGenerator.generatePickaxe(MaterialInit.TOURMALINE));
                ...
                output.accept(PartToolGenerator.generatePickaxe(MaterialInit.SULFURIC_ACID_BATTERY));
                ...
                output.accept(PartToolGenerator.generateHammer(MaterialInit.ZINC));
                output.accept(PartToolGenerator.generateHammer(MaterialInit.BONE));
                output.accept(PartToolGenerator.generateHammer(MaterialInit.GLASS));
                output.accept(PartToolGenerator.generateHammer(MaterialInit.SANDSTONE));
                ...
                output.accept(PartToolGenerator.generateHammer(MaterialInit.TOURMALINE));
                ...
                output.accept(PartToolGenerator.generateHammer(MaterialInit.SULFURIC_ACID_BATTERY));
                ...
                output.accept(PartToolGenerator.generateAxe(MaterialInit.ZINC));
                output.accept(PartToolGenerator.generateAxe(MaterialInit.BONE));
                output.accept(PartToolGenerator.generateAxe(MaterialInit.GLASS));
                output.accept(PartToolGenerator.generateAxe(MaterialInit.SANDSTONE));
                ...
                output.accept(PartToolGenerator.generateAxe(MaterialInit.TOURMALINE));
                ...
                output.accept(PartToolGenerator.generateAxe(MaterialInit.SULFURIC_ACID_BATTERY));
                ...
                output.accept(PartToolGenerator.generateShovel(MaterialInit.ZINC));
                output.accept(PartToolGenerator.generateShovel(MaterialInit.BONE));
                output.accept(PartToolGenerator.generateShovel(MaterialInit.GLASS));
                output.accept(PartToolGenerator.generateShovel(MaterialInit.SANDSTONE));
                ...
                output.accept(PartToolGenerator.generateShovel(MaterialInit.TOURMALINE));
                ...
                output.accept(PartToolGenerator.generateShovel(MaterialInit.SULFURIC_ACID_BATTERY));
                ...
                output.accept(PartToolGenerator.generateScythe(MaterialInit.ZINC));
                output.accept(PartToolGenerator.generateScythe(MaterialInit.BONE));
                output.accept(PartToolGenerator.generateScythe(MaterialInit.GLASS));
                output.accept(PartToolGenerator.generateScythe(MaterialInit.SANDSTONE));
                ...
                output.accept(PartToolGenerator.generateScythe(MaterialInit.TOURMALINE));
                ...
                output.accept(PartToolGenerator.generateScythe(MaterialInit.SULFURIC_ACID_BATTERY));
                ...
                output.accept(PartToolGenerator.generateWand(MaterialInit.ZINC));
                output.accept(PartToolGenerator.generateWand(MaterialInit.BONE));
                output.accept(PartToolGenerator.generateWand(MaterialInit.GLASS));
                output.accept(PartToolGenerator.generateWand(MaterialInit.SANDSTONE));
                ...
                output.accept(PartToolGenerator.generateWand(MaterialInit.TOURMALINE));
                ...
                output.accept(PartToolGenerator.generateWand(MaterialInit.SULFURIC_ACID_BATTERY));
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MAGITECH_PART_TAB = CREATIVE_MODE_TABS.register("magitech_part_tab", () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                for (Item item : partList) {
                    ...
                    output.accept(PartToolGenerator.generatePart((PartItem) item, MaterialInit.ZINC));
                    output.accept(PartToolGenerator.generatePart((PartItem) item, MaterialInit.BONE));
                    output.accept(PartToolGenerator.generatePart((PartItem) item, MaterialInit.GLASS));
                    output.accept(PartToolGenerator.generatePart((PartItem) item, MaterialInit.SANDSTONE));
                    ...
                    output.accept(PartToolGenerator.generatePart((PartItem) item, MaterialInit.TOURMALINE));
                    ...
                    output.accept(PartToolGenerator.generatePart((PartItem) item, MaterialInit.SULFURIC_ACID_BATTERY));
