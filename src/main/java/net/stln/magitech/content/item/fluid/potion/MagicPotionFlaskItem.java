...
public class MagicPotionFlaskItem extends DrinkableFlaskItem {

    public MagicPotionFlaskItem(Properties properties) {
        super(properties);
    }
    ...
    protected void applyEffects(Level level, LivingEntity entity, ItemStack stack) {
        ...
        EffectHelper.entityEffect(level, new PowerupParticleEffect(new Vector3f(1.0F, 0.5F, 0.7F), new Vector3f(1.0F, 0.0F, 1.0F), 1F, 1, 0, 15, 1.0F), entity, 20);
    }
}
