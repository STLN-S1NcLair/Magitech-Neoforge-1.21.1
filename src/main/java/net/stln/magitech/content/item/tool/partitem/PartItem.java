        ...
        if (stack.has(ComponentInit.MATERIAL_COMPONENT)) {
            ...
            if (shiftDown) {
                tooltipComponents.add(Component.translatable("attribute.magitech.attack_damage").append(": ").withColor(0xa0a0a0)
                        .append(Component.literal("x" + MathHelper.round(finalStats.getStats().get(ToolStats.ATK_STAT), 2)).withColor(0xFF4040)));
                ...
                tooltipComponents.add(Component.translatable("attribute.magitech.elemental_damage").append(": ").withColor(0xa0a0a0)
                        .append(Component.translatable("element.magitech." + finalStats.getElement().get())
                                .append(" ")
                                .append(Component.literal("x" + MathHelper.round(finalStats.getStats().get(ToolStats.ELM_ATK_STAT), 2))).withColor(finalStats.getElement().getTextColor().getRGB())));
                ...
                tooltipComponents.add(Component.translatable("attribute.magitech.mining_speed").append(": ").withColor(0xa0a0a0)
                        .append(Component.literal("x" + MathHelper.round(finalStats.getStats().get(ToolStats.MIN_STAT), 2)).withColor(0x4080C0)));

                tooltipComponents.add(Component.translatable("attribute.magitech.defense").append(": ").withColor(0xa0a0a0)
                        .append(Component.literal("x" + MathHelper.round(finalStats.getStats().get(ToolStats.DEF_STAT), 2)).withColor(0xA0C0C0)));

                tooltipComponents.add(Component.translatable("attribute.magitech.attack_range").append(": ").withColor(0xa0a0a0)
                        .append(Component.literal("x" + MathHelper.round(finalStats.getStats().get(ToolStats.RNG_STAT), 2)).withColor(0x80c0FF)));

                tooltipComponents.add(Component.translatable("attribute.magitech.sweep_range").append(": ").withColor(0xa0a0a0)
                        .append(Component.literal("x" + MathHelper.round(finalStats.getStats().get(ToolStats.SWP_STAT), 2)).withColor(0xFFFF80)));

                tooltipComponents.add(Component.translatable("attribute.magitech.durability").append(": ").withColor(0xa0a0a0)
                        .append(Component.literal("x" +
                                MathHelper.round(finalStats.getStats().get(ToolStats.DUR_STAT), 2)
                        ).withColor(0xFFFFFF)));
                ...
                tooltipComponents.add(Component.translatable("attribute.magitech.spell_power").append(": ").withColor(0xa0a0a0)
                        .append(Component.literal("x" + MathHelper.round(spellCasterStats.getStats().get(ToolStats.ATK_STAT), 2)).withColor(0xFF4040)));
                ...
                tooltipComponents.add(Component.translatable("attribute.magitech.elemental_spell_power").append(": ").withColor(0xa0a0a0)
                        .append(Component.translatable("element.magitech." + spellCasterStats.getElement().get())
                                .append(" ")
                                .append(Component.literal("x" + MathHelper.round(spellCasterStats.getStats().get(ToolStats.ELM_ATK_STAT), 2))).withColor(spellCasterStats.getElement().getTextColor().getRGB())));
                ...
                tooltipComponents.add(Component.translatable("attribute.magitech.cooldown_speed").append(": ").withColor(0xa0a0a0)
                        .append(Component.literal("x" + MathHelper.round(spellCasterStats.getStats().get(ToolStats.MIN_STAT), 2)).withColor(0x4080C0)));

                tooltipComponents.add(Component.translatable("attribute.magitech.defense").append(": ").withColor(0xa0a0a0)
                        .append(Component.literal("x" + MathHelper.round(spellCasterStats.getStats().get(ToolStats.DEF_STAT), 2)).withColor(0xA0C0C0)));

                tooltipComponents.add(Component.translatable("attribute.magitech.projectile_speed").append(": ").withColor(0xa0a0a0)
                        .append(Component.literal("x" + MathHelper.round(spellCasterStats.getStats().get(ToolStats.RNG_STAT), 2)).withColor(0x80c0FF)));

                tooltipComponents.add(Component.translatable("attribute.magitech.mana_efficiency").append(": ").withColor(0xa0a0a0)
                        .append(Component.literal("x" + MathHelper.round(spellCasterStats.getStats().get(ToolStats.SWP_STAT), 2)).withColor(0xFFFF80)));
