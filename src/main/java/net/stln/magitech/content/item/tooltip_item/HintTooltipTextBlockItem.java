...
public class HintTooltipTextBlockItem extends BlockItem {
    public HintTooltipTextBlockItem(Block block, Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, @NotNull TooltipContext context, List<Component> tooltipComponents, @NotNull TooltipFlag tooltipFlag) {
        tooltipComponents.add(Component.translatable("tooltip.hint.block." + stack.getItem().toString().replace(":", ".")).withColor(0xC0C0C0));
