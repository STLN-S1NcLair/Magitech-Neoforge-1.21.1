...
import net.stln.magitech.feature.tool.property.modifier.ConstantToolPropertyModifier;
...
import net.stln.magitech.feature.tool.property.modifier.ValueToolPropertyModifier;
...
public class InfusedTrait extends Trait {
    ...
    public List<ToolPropertyModifier> modifyProperty(Player player, Level level, ItemStack stack, int traitLevel, ToolProperties properties) {
        ToolPropertyModifier mod = new ConstantToolPropertyModifier(ToolPropertyCategory.ELEMENT, 0.75F * traitLevel);
        return List.of(mod);
    }

    @Override
    public Color getColor() {
        return new Color(0xBBD3E7);
    }
