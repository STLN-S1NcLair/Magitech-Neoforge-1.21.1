...
public class ToolPropertyInit {
    ...
    // 一般プロパティ
    public static final DeferredToolProperty<SimpleAttributeToolProperty> DEFENSE = register("defense", f -> new DefenseToolProperty(f, Attributes.ARMOR, ToolPropertyCategory.DEFENSE));
