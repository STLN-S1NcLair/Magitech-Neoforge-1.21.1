...
public class MaterialInit {
    ...
    public static final DeferredToolMaterial<ToolMaterial> SNOW = register("snow", new FrozenTrait(), () -> new ToolProperties(ToolCategoryInit.ALL)
            ...
            .set(ToolPropertyInit.ELEMENTAL_DAMAGE, ElementalAttributeToolProperty.singleElement(Element.GLACE, 0.6))
            .set(ToolPropertyInit.ATTACK_SPEED, 1.4)
            .set(ToolPropertyInit.MINING_SPEED, 0.5)
            .set(ToolPropertyInit.DEFENSE, 0.5)
            .set(ToolPropertyInit.REACH, 0.9)
            .set(ToolPropertyInit.SWEEP, 0.7)
            ...
            .set(ToolPropertyInit.ELEMENTAL_POWER, ElementalAttributeToolProperty.singleElement(Element.GLACE, 0.9))
            .set(ToolPropertyInit.CHARGE_SPEED, 0.8)
            .set(ToolPropertyInit.COOLDOWN_SPEED, 0.7)
    ...
    public static final DeferredToolMaterial<ToolMaterial> BRICK = register("brick", new SturdyTrait(), () -> new ToolProperties(ToolCategoryInit.ALL)
            ...
            .set(ToolPropertyInit.ELEMENTAL_DAMAGE, ElementalAttributeToolProperty.none())
            .set(ToolPropertyInit.ATTACK_SPEED, 0.7)
            .set(ToolPropertyInit.MINING_SPEED, 0.7)
            .set(ToolPropertyInit.DEFENSE, 1.2)
            .set(ToolPropertyInit.REACH, 0.7)
            .set(ToolPropertyInit.SWEEP, 0.9)
            .set(ToolPropertyInit.DURABILITY, 0.5)
    ...
    public static final DeferredToolMaterial<ToolMaterial> BASALT = register("basalt", new CollapseTrait(), () -> new ToolProperties(ToolCategoryInit.ALL)
            ...
            .set(ToolPropertyInit.MAX_PROGRESSION_COEFFICIENT, 1.0)
            .set(ToolPropertyInit.DAMAGE, 0.8)
            .set(ToolPropertyInit.ELEMENTAL_DAMAGE, ElementalAttributeToolProperty.singleElement(Element.TREMOR, 0.4))
            .set(ToolPropertyInit.ATTACK_SPEED, 0.65)
            .set(ToolPropertyInit.MINING_SPEED, 1.0)
            ...
            .set(ToolPropertyInit.MINING_LEVEL, MiningLevel.STONE)
            .set(ToolPropertyInit.POWER, 1.0)
            .set(ToolPropertyInit.ELEMENTAL_POWER, ElementalAttributeToolProperty.singleElement(Element.TREMOR, 0.3))
            .set(ToolPropertyInit.CHARGE_SPEED, 0.65)
            .set(ToolPropertyInit.COOLDOWN_SPEED, 1.0)
            .set(ToolPropertyInit.LAUNCH, 1.1)
            .set(ToolPropertyInit.MANA_EFFICIENCY, 1.2)
    ...
    public static final DeferredToolMaterial<ToolMaterial> SLIME = register("slime", new StickyTrait(), () -> new ToolProperties(ToolCategoryInit.ALL)
            ...
            .set(ToolPropertyInit.MAX_PROGRESSION_COEFFICIENT, 1.0)
            .set(ToolPropertyInit.DAMAGE, 0.2)
            .set(ToolPropertyInit.ELEMENTAL_DAMAGE, ElementalAttributeToolProperty.singleElement(Element.FLOW, 1.6))
            .set(ToolPropertyInit.ATTACK_SPEED, 0.6)
            .set(ToolPropertyInit.MINING_SPEED, 0.2)
            .set(ToolPropertyInit.DEFENSE, 0.0)
            .set(ToolPropertyInit.REACH, 0.8)
            .set(ToolPropertyInit.SWEEP, 1.6)
            .set(ToolPropertyInit.DURABILITY, 0.1)
            .set(ToolPropertyInit.MINING_LEVEL, MiningLevel.NONE)
            .set(ToolPropertyInit.POWER, 0.2)
            .set(ToolPropertyInit.ELEMENTAL_POWER, ElementalAttributeToolProperty.singleElement(Element.FLOW, 1.6))
            .set(ToolPropertyInit.CHARGE_SPEED, 0.6)
            .set(ToolPropertyInit.COOLDOWN_SPEED, 0.4)
            .set(ToolPropertyInit.LAUNCH, 0.8)
    ...
    public static final DeferredToolMaterial<ToolMaterial> NETHER_BRICK = register("nether_brick", new ScorchedTrait(), () -> new ToolProperties(ToolCategoryInit.ALL)
            ...
            .set(ToolPropertyInit.DAMAGE, 0.9)
            .set(ToolPropertyInit.ELEMENTAL_DAMAGE, ElementalAttributeToolProperty.singleElement(Element.EMBER, 0.3))
            .set(ToolPropertyInit.ATTACK_SPEED, 0.95)
            .set(ToolPropertyInit.MINING_SPEED, 1.05)
            .set(ToolPropertyInit.DEFENSE, 1.3)
            .set(ToolPropertyInit.REACH, 0.9)
            .set(ToolPropertyInit.SWEEP, 1.0)
            .set(ToolPropertyInit.DURABILITY, 0.6)
            .set(ToolPropertyInit.MINING_LEVEL, MiningLevel.STONE)
            .set(ToolPropertyInit.POWER, 1.0)
            .set(ToolPropertyInit.ELEMENTAL_POWER, ElementalAttributeToolProperty.singleElement(Element.EMBER, 0.3))
            .set(ToolPropertyInit.CHARGE_SPEED, 0.7)
            .set(ToolPropertyInit.COOLDOWN_SPEED, 0.8)
            .set(ToolPropertyInit.LAUNCH, 0.8)
            .set(ToolPropertyInit.MANA_EFFICIENCY, 1.0)
    ...
    public static final DeferredToolMaterial<ToolMaterial> PHANTOM_MEMBRANE = register("phantom_membrane", new InsomniaTrait(), () -> new ToolProperties(ToolCategoryInit.ALL)
            ...
            .set(ToolPropertyInit.MAX_PROGRESSION_COEFFICIENT, 1.0)
            .set(ToolPropertyInit.DAMAGE, 0.0)
            .set(ToolPropertyInit.ELEMENTAL_DAMAGE, ElementalAttributeToolProperty.singleElement(Element.PHANTOM, 0.8))
            .set(ToolPropertyInit.ATTACK_SPEED, 1.3)
            ...
            .set(ToolPropertyInit.DURABILITY, 0.5)
            .set(ToolPropertyInit.MINING_LEVEL, MiningLevel.STONE)
            .set(ToolPropertyInit.POWER, 0.0)
            .set(ToolPropertyInit.ELEMENTAL_POWER, ElementalAttributeToolProperty.singleElement(Element.PHANTOM, 1.6))
            .set(ToolPropertyInit.CHARGE_SPEED, 1.0)
            .set(ToolPropertyInit.COOLDOWN_SPEED, 0.5)
            .set(ToolPropertyInit.LAUNCH, 1.1)
            .set(ToolPropertyInit.MANA_EFFICIENCY, 0.7)
    ...
    public static final DeferredToolMaterial<ToolMaterial> GLOWSTONE = register("glowstone", new IlluminationTrait(), () -> new ToolProperties(ToolCategoryInit.ALL)
            ...
            .set(ToolPropertyInit.MAX_PROGRESSION_COEFFICIENT, 1.0)
            .set(ToolPropertyInit.DAMAGE, 0.8)
            .set(ToolPropertyInit.ELEMENTAL_DAMAGE, ElementalAttributeToolProperty.singleElement(Element.PHANTOM, 0.6))
            .set(ToolPropertyInit.ATTACK_SPEED, 0.8)
            .set(ToolPropertyInit.MINING_SPEED, 1.1)
            .set(ToolPropertyInit.DEFENSE, 1.1)
            .set(ToolPropertyInit.REACH, 0.8)
            ...
            .set(ToolPropertyInit.MINING_LEVEL, MiningLevel.STONE)
            .set(ToolPropertyInit.POWER, 1.1)
            .set(ToolPropertyInit.ELEMENTAL_POWER, ElementalAttributeToolProperty.singleElement(Element.PHANTOM, 0.2))
            .set(ToolPropertyInit.CHARGE_SPEED, 1.0)
            .set(ToolPropertyInit.COOLDOWN_SPEED, 1.2)
            .set(ToolPropertyInit.LAUNCH, 1.0)
            .set(ToolPropertyInit.MANA_EFFICIENCY, 1.2)
    ...
    public static final DeferredToolMaterial<ToolMaterial> OBSIDIAN = register("obsidian", new SeveringTrait(), () -> new ToolProperties(ToolCategoryInit.ALL)
            ...
            .set(ToolPropertyInit.ELEMENTAL_DAMAGE, ElementalAttributeToolProperty.none())
            .set(ToolPropertyInit.ATTACK_SPEED, 0.5)
            .set(ToolPropertyInit.MINING_SPEED, 1.7)
            .set(ToolPropertyInit.DEFENSE, 1.5)
            .set(ToolPropertyInit.REACH, 0.9)
            .set(ToolPropertyInit.SWEEP, 1.0)
            .set(ToolPropertyInit.DURABILITY, 2.0)
            .set(ToolPropertyInit.MINING_LEVEL, MiningLevel.DIAMOND)
            .set(ToolPropertyInit.POWER, 1.6)
            .set(ToolPropertyInit.ELEMENTAL_POWER, ElementalAttributeToolProperty.none())
            .set(ToolPropertyInit.CHARGE_SPEED, 0.5)
            .set(ToolPropertyInit.COOLDOWN_SPEED, 1.2)
            .set(ToolPropertyInit.LAUNCH, 1.0)
    ...
    public static final DeferredToolMaterial<ToolMaterial> END_STONE = register("end_stone", new AbnormalityTrait(), () -> new ToolProperties(ToolCategoryInit.ALL)
            ...
            .set(ToolPropertyInit.MAX_PROGRESSION_COEFFICIENT, 1.0)
            .set(ToolPropertyInit.DAMAGE, 0.9)
            .set(ToolPropertyInit.ELEMENTAL_DAMAGE, ElementalAttributeToolProperty.singleElement(Element.HOLLOW, 0.4))
            .set(ToolPropertyInit.ATTACK_SPEED, 1.0)
            .set(ToolPropertyInit.MINING_SPEED, 1.1)
            .set(ToolPropertyInit.DEFENSE, 1.5)
            .set(ToolPropertyInit.REACH, 1.2)
            .set(ToolPropertyInit.SWEEP, 0.8)
            .set(ToolPropertyInit.DURABILITY, 2.1)
            .set(ToolPropertyInit.MINING_LEVEL, MiningLevel.STONE)
            .set(ToolPropertyInit.POWER, 1.0)
            .set(ToolPropertyInit.ELEMENTAL_POWER, ElementalAttributeToolProperty.singleElement(Element.HOLLOW, 0.7))
            .set(ToolPropertyInit.CHARGE_SPEED, 1.0)
            .set(ToolPropertyInit.COOLDOWN_SPEED, 1.1)
    ...
    public static final DeferredToolMaterial<ToolMaterial> FLUXIUM = register("fluxium", new InfusedTrait(), () -> new ToolProperties(ToolCategoryInit.ALL)
            ...
            .set(ToolPropertyInit.MAX_PROGRESSION_COEFFICIENT, 1.0)
            .set(ToolPropertyInit.DAMAGE, 1.2)
            .set(ToolPropertyInit.ELEMENTAL_DAMAGE, ElementalAttributeToolProperty.singleElement(Element.MANA, 0.1))
            .set(ToolPropertyInit.ATTACK_SPEED, 1.0)
            .set(ToolPropertyInit.MINING_SPEED, 1.4)
            .set(ToolPropertyInit.DEFENSE, 0.5)
            .set(ToolPropertyInit.REACH, 1.1)
            .set(ToolPropertyInit.SWEEP, 0.8)
            .set(ToolPropertyInit.DURABILITY, 2.8)
            .set(ToolPropertyInit.MINING_LEVEL, MiningLevel.IRON)
            .set(ToolPropertyInit.POWER, 1.0)
            .set(ToolPropertyInit.ELEMENTAL_POWER, ElementalAttributeToolProperty.singleElement(Element.MANA, 0.1))
            .set(ToolPropertyInit.CHARGE_SPEED, 1.3)
            .set(ToolPropertyInit.COOLDOWN_SPEED, 1.4)
            .set(ToolPropertyInit.LAUNCH, 1.2)
    ...
    public static final DeferredToolMaterial<ToolMaterial> ALCHECRYSITE = register("alchecrysite", new TuningTrait(), () -> new ToolProperties(ToolCategoryInit.ALL)
            ...
            .set(ToolPropertyInit.MAX_PROGRESSION_COEFFICIENT, 1.0)
            .set(ToolPropertyInit.DAMAGE, 0.8)
            .set(ToolPropertyInit.ELEMENTAL_DAMAGE, ElementalAttributeToolProperty.singleElement(Element.MAGIC, 0.4))
            .set(ToolPropertyInit.ATTACK_SPEED, 0.85)
            .set(ToolPropertyInit.MINING_SPEED, 1.3)
            .set(ToolPropertyInit.DEFENSE, 1.0)
            .set(ToolPropertyInit.REACH, 1.0)
            ...
            .set(ToolPropertyInit.MINING_LEVEL, MiningLevel.IRON)
            .set(ToolPropertyInit.POWER, 0.8)
            .set(ToolPropertyInit.ELEMENTAL_POWER, ElementalAttributeToolProperty.singleElement(Element.MAGIC, 0.9))
            .set(ToolPropertyInit.CHARGE_SPEED, 1.8)
            .set(ToolPropertyInit.COOLDOWN_SPEED, 0.3)
