...
public class UpgradeInit {
    ...
    public static final DeferredUpgrade<Upgrade> RANGE_UPGRADE = register("range_upgrade", new SingleUpgrade(new RationalToolPropertyModifier(ToolPropertyCategory.DEFENSE, 0.05F), ToolCategoryInit.ALL));
