...
public class UpgradeInit {
    ...
    public static final DeferredUpgrade<Upgrade> DEFENCE_UPGRADE = register("defence_upgrade", new SingleUpgrade(new RationalToolPropertyModifier(ToolPropertyCategory.DEFENSE, 0.05F), ToolCategoryInit.ALL));
    public static final DeferredUpgrade<Upgrade> RANGE_UPGRADE = register("range_upgrade", new SingleUpgrade(new RationalToolPropertyModifier(ToolPropertyCategory.RANGE, 0.05F), ToolCategoryInit.ALL));
    public static final DeferredUpgrade<Upgrade> SWEEP_UPGRADE = register("unique_upgrade", new SingleUpgrade(new RationalToolPropertyModifier(ToolPropertyCategory.UNIQUE, 0.05F), ToolCategoryInit.ALL));
