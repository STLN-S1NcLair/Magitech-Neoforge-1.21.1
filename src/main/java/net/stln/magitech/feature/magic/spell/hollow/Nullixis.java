...
public class Nullixis extends Spell {
    ...
    public void use(Level level, Player user, InteractionHand hand, boolean isHost) {
        ...
        if (!level.isClientSide && !isHost) {
            NullixisEntity bullet = new NullixisEntity(level, user, user.getItemInHand(hand), getDamage(user, this.getCost(level, user, user.getItemInHand(hand)), baseDamage, this.getElement()));
