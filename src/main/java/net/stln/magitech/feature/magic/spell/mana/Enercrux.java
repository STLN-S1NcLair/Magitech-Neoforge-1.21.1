package net.stln.magitech.feature.magic.spell.mana;
...
public class Enercrux extends BeamSpell {
    ...
    protected void addVisualEffect(Level level, Player user, Vec3 start, Vec3 hitPos) {
        EffectHelper.lineEffect(level, new UnstableSquareParticleEffect(new Vector3f(0.8F, 1.0F, 0.7F), new Vector3f(0.0F, 1.0F, 0.9F), 1.0F, user.getRandom().nextInt(2, 5), 0, 15, 0.0F), start, hitPos, 2, false);
