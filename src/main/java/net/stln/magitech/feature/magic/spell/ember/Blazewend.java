        ...
        for (int i = 0; i < duration; i++) {
            ...
            TickScheduler.schedule(i, () -> {
                ...
                for (Entity entity : nearbyEntities) {
                    EffectHelper.entityEffect(level, new FlameParticleEffect(new Vector3f(1.0F, 1.0F, 1.0F), new Vector3f(1.0F, 1.0F, 1.0F), 1.0F, 1, 0, level.random.nextInt(5, 8), 0.9F), entity, 30);
