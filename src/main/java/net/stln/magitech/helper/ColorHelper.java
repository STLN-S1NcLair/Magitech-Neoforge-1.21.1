...
public class ColorHelper {
    ...
    public static class Argb {
        ...
        public static int lerp(float delta, int start, int end) {
            int i = (int) Mth.lerp(delta, getAlpha(start), getAlpha(end));
            int j = (int) Mth.lerp(delta, getRed(start), getRed(end));
            int k = (int) Mth.lerp(delta, getGreen(start), getGreen(end));
            int l = (int) Mth.lerp(delta, getBlue(start), getBlue(end));
