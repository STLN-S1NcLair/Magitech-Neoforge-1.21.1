...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        basicItem(ItemInit.VULCANITE.get());
        basicItem(ItemInit.POLISHED_VULCANITE.get());
        basicItem(ItemInit.FRIGIDITE.get());
        basicItem(ItemInit.POLISHED_FRIGIDITE.get());
        basicItem(ItemInit.FULMINITE.get());
        basicItem(ItemInit.POLISHED_FULMINITE.get());
        ...
        basicItem(ItemInit.ARCEUM.get());
        basicItem(ItemInit.POLISHED_ARCEUM.get());
        basicItem(ItemInit.TERRADITE.get());
        basicItem(ItemInit.POLISHED_TERRADITE.get());
