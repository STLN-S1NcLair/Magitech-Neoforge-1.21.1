...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(BlockTags.MINEABLE_WITH_PICKAXE).add(BlockInit.ENGINEERING_WORKBENCH.get(), BlockInit.ASSEMBLY_WORKBENCH.get(), BlockInit.REPAIRING_WORKBENCH.get(), BlockInit.UPGRADE_WORKBENCH.get(), BlockInit.INFUSION_ALTAR.get(), BlockInit.PEDESTAL_PYLON.get(), BlockInit.MANA_NODE.get(), BlockInit.MANA_RELAY.get(), BlockInit.MANA_VESSEL.get(), BlockInit.MANA_STRANDER.get(), BlockInit.MANA_RECEIVER.get(), BlockInit.MANA_COLLECTOR.get(), BlockInit.INFUSER.get(), BlockInit.CRUSHER.get(), BlockInit.COMPRESSOR.get(), BlockInit.EMBER_SMELTER.get(), BlockInit.ITEM_COLLECTOR.get(), BlockInit.MANA_JUNCTION.get(), BlockInit.ENTANGLER.get(), BlockInit.DETANGLER.get(), BlockInit.MANA_PUMP.get(), BlockInit.ENHANCED_MANA_NODE.get(), BlockInit.ENHANCED_MANA_RELAY.get(), BlockInit.ENHANCED_MANA_VESSEL.get(), BlockInit.CHILLER.get(), BlockInit.ZARDIUS_CRUCIBLE.get(), BlockInit.FLUORITE_ORE.get(), BlockInit.DEEPSLATE_FLUORITE_ORE.get(), BlockInit.TOURMALINE_ORE.get(), BlockInit.DEEPSLATE_TOURMALINE_ORE.get(), BlockInit.ZINC_ORE.get(), BlockInit.DEEPSLATE_ZINC_ORE.get(), BlockInit.RAW_ZINC_BLOCK.get(), BlockInit.FLUORITE_CRYSTAL_CLUSTER.get(), BlockInit.REDSTONE_CRYSTAL_CLUSTER.get(), BlockInit.SULFUR_CRYSTAL_CLUSTER.get(), BlockInit.SULFUR_BLOCK.get(), BlockInit.VESPERITE.get(), BlockInit.VESPERITE_STAIRS.get(), BlockInit.VESPERITE_SLAB.get(), BlockInit.VESPERITE_WALL.get(), BlockInit.ALCHECRYSITE.get(), BlockInit.ALCHECRYSITE_STAIRS.get(), BlockInit.ALCHECRYSITE_SLAB.get(), BlockInit.ALCHECRYSITE_WALL.get(), BlockInit.POLISHED_ALCHECRYSITE.get(), BlockInit.POLISHED_ALCHECRYSITE_STAIRS.get(), BlockInit.POLISHED_ALCHECRYSITE_SLAB.get(), BlockInit.POLISHED_ALCHECRYSITE_WALL.get(), BlockInit.ALCHECRYSITE_BRICKS.get(), BlockInit.ALCHECRYSITE_BRICK_STAIRS.get(), BlockInit.ALCHECRYSITE_BRICK_SLAB.get(), BlockInit.ALCHECRYSITE_BRICK_WALL.get(), BlockInit.ALCHECRYSITE_TILES.get(), BlockInit.FLUORITE_BLOCK.get(), BlockInit.FLUORITE_BRICKS.get(), BlockInit.FLUORITE_BRICK_STAIRS.get(), BlockInit.FLUORITE_BRICK_SLAB.get(), BlockInit.FLUORITE_BRICK_WALL.get());
        ...
        tag(BlockTags.NEEDS_STONE_TOOL).add(BlockInit.MANA_NODE.get(), BlockInit.MANA_RELAY.get(), BlockInit.MANA_VESSEL.get(), BlockInit.MANA_STRANDER.get(), BlockInit.MANA_RECEIVER.get(), BlockInit.MANA_COLLECTOR.get(), BlockInit.INFUSER.get(), BlockInit.CRUSHER.get(), BlockInit.COMPRESSOR.get(), BlockInit.EMBER_SMELTER.get(), BlockInit.ITEM_COLLECTOR.get(), BlockInit.MANA_JUNCTION.get(), BlockInit.ENTANGLER.get(), BlockInit.DETANGLER.get(), BlockInit.MANA_PUMP.get(), BlockInit.ENHANCED_MANA_NODE.get(), BlockInit.ENHANCED_MANA_RELAY.get(), BlockInit.ENHANCED_MANA_VESSEL.get(), BlockInit.FLUORITE_CRYSTAL_CLUSTER.get(), BlockInit.REDSTONE_CRYSTAL_CLUSTER.get(), BlockInit.FLUORITE_ORE.get(), BlockInit.DEEPSLATE_FLUORITE_ORE.get());
