...
public class MembraneParticle extends GlowingParticle {
    ...
    public MembraneParticle(ClientLevel clientWorld, double x, double y, double z, double vx, double vy, double vz,
                            MembraneParticleEffect parameters, SpriteSet spriteProvider) {
    ...
    public static class Provider implements ParticleProvider<MembraneParticleEffect> {
        ...
        @Override
        public @Nullable Particle createParticle(MembraneParticleEffect parameters, ClientLevel world, double x, double y, double z, double xd, double yd, double zd) {
            return new MembraneParticle(world, x, y, z, xd, yd, zd, parameters, this.spriteProvider);
        }
    }
}
