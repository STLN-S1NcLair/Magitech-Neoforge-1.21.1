...
public class SparkParticle extends GlowingParticle {
    ...
    public SparkParticle(ClientLevel clientWorld, double x, double y, double z, double vx, double vy, double vz,
                         SparkParticleEffect parameters, SpriteSet spriteProvider) {
    ...
    public static class Provider implements ParticleProvider<SparkParticleEffect> {
        ...
        @Override
        public @Nullable Particle createParticle(SparkParticleEffect parameters, ClientLevel world, double x, double y, double z, double xd, double yd, double zd) {
