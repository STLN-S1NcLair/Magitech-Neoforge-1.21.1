...
public class VoidGlowParticle extends GlowingParticle {
    ...
    public VoidGlowParticle(ClientLevel clientWorld, double x, double y, double z, double vx, double vy, double vz,
                            VoidGlowParticleEffect parameters, SpriteSet spriteProvider) {
    ...
    public static class Provider implements ParticleProvider<VoidGlowParticleEffect> {
        ...
        @Override
        public @Nullable Particle createParticle(VoidGlowParticleEffect parameters, ClientLevel world, double x, double y, double z, double xd, double yd, double zd) {
            return new VoidGlowParticle(world, x, y, z, xd, yd, zd, parameters, this.spriteProvider);
        }
    }
}
