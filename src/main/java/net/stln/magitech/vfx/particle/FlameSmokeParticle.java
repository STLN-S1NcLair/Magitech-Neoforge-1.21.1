package net.stln.magitech.vfx.particle;
...
public class FlameSmokeParticle extends AbstractCustomizableParticle {
    ...
    public FlameSmokeParticle(ClientLevel clientWorld, double x, double y, double z, double vx, double vy, double vz,
                              FlameSmokeParticleEffect parameters, SpriteSet spriteProvider) {
    ...
    public void render(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
        ...
        if (this.age >= this.lifetime * 0.8F) {
            ...
            this.alpha = (this.age - this.lifetime) / ((this.age - this.lifetime) * 0.2F) * 0.6F + 0.2F;
            this.alpha *= 0.8F;
        } else {
            this.alpha = 0.8F;
        }
    ...
    public static class Provider implements ParticleProvider<FlameSmokeParticleEffect> {
        ...
        @Override
        public @Nullable Particle createParticle(FlameSmokeParticleEffect parameters, ClientLevel world, double x, double y, double z, double xd, double yd, double zd) {
            return new FlameSmokeParticle(world, x, y, z, xd, yd, zd, parameters, this.spriteProvider);
        }
    }
}
