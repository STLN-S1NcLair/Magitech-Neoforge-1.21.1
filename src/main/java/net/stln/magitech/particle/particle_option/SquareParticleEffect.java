...
public class SquareParticleEffect extends AbstractCustomizableParticleEffect {
    ...
    public static final StreamCodec<ByteBuf, SquareParticleEffect> STREAM_CODEC = StreamCodec.composite(
    ...
    public SquareParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed) {
