...
public class WaveNoCullParticleEffect extends AbstractCustomizableParticleEffect {
    ...
    public static final StreamCodec<ByteBuf, WaveNoCullParticleEffect> STREAM_CODEC = StreamCodec.composite(
    ...
    public WaveNoCullParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed) {
