...
public class VoidGlowParticleEffect extends AbstractCustomizableParticleEffect {
    ...
    public static final StreamCodec<ByteBuf, VoidGlowParticleEffect> STREAM_CODEC = StreamCodec.composite(
    ...
    public VoidGlowParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed) {
