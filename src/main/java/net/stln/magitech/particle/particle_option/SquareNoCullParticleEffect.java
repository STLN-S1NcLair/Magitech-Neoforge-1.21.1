...
public class SquareNoCullParticleEffect extends AbstractCustomizableParticleEffect {
    ...
    public static final StreamCodec<ByteBuf, SquareNoCullParticleEffect> STREAM_CODEC = StreamCodec.composite(
    ...
    public SquareNoCullParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed) {
