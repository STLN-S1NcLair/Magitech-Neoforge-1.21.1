...
public class PowerupParticleEffect extends AbstractCustomizableParticleEffect {
    ...
    public static final StreamCodec<ByteBuf, PowerupParticleEffect> STREAM_CODEC = StreamCodec.composite(
    ...
    public PowerupParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed) {
