...
public class SparkParticleEffect extends AbstractCustomizableParticleEffect {
    ...
    public static final StreamCodec<ByteBuf, SparkParticleEffect> STREAM_CODEC = StreamCodec.composite(
    ...
    public SparkParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed) {
