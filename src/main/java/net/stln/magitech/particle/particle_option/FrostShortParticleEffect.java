...
public class FrostShortParticleEffect extends AbstractCustomizableParticleEffect {
    ...
    public static final StreamCodec<ByteBuf, FrostShortParticleEffect> STREAM_CODEC = StreamCodec.composite(
    ...
    public FrostShortParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed) {
