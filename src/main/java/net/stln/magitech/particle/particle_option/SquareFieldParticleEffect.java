...
public class SquareFieldParticleEffect extends AbstractCustomizableParticleEffect {
    ...
    public static final StreamCodec<ByteBuf, SquareFieldParticleEffect> STREAM_CODEC = StreamCodec.composite(
    ...
    public SquareFieldParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed) {
