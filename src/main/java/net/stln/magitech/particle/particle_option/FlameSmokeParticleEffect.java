...
public class FlameSmokeParticleEffect extends AbstractCustomizableParticleEffect {
    ...
    public static final StreamCodec<ByteBuf, FlameSmokeParticleEffect> STREAM_CODEC = StreamCodec.composite(
    ...
    public FlameSmokeParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed) {
