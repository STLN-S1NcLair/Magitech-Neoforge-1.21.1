...
public class ZapParticleEffect extends AbstractCustomizableParticleEffect {
    ...
    public static final StreamCodec<ByteBuf, ZapParticleEffect> STREAM_CODEC = StreamCodec.composite(
    ...
    public ZapParticleEffect(Vector3f fromColor, Vector3f toColor, Vector3f toPos, float scale, int twinkle, float rotSpeed) {
