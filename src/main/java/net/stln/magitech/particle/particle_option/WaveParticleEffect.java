...
public class WaveParticleEffect extends AbstractCustomizableParticleEffect {
    ...
    public static final StreamCodec<ByteBuf, WaveParticleEffect> STREAM_CODEC = StreamCodec.composite(
    ...
    public WaveParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed) {
