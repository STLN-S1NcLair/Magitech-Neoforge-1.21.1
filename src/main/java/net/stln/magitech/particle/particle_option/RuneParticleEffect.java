...
public class RuneParticleEffect extends AbstractCustomizableParticleEffect {
    ...
    public static final StreamCodec<ByteBuf, RuneParticleEffect> STREAM_CODEC = StreamCodec.composite(
    ...
    public RuneParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed) {
