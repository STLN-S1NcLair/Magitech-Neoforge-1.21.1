...
public class BlowParticleEffect extends AbstractCustomizableParticleEffect {
    ...
    public static final StreamCodec<ByteBuf, BlowParticleEffect> STREAM_CODEC = StreamCodec.composite(
    ...
    public BlowParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed) {
