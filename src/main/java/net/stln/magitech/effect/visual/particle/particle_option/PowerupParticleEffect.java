...
public class PowerupParticleEffect extends AbstractCustomizableParticleEffect {
    public static final MapCodec<PowerupParticleEffect> CODEC = RecordCodecBuilder.mapCodec(
    ...
    public static final StreamCodec<ByteBuf, PowerupParticleEffect> STREAM_CODEC = composite(
    ...
    public PowerupParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed, int lifetime, float friction) {
