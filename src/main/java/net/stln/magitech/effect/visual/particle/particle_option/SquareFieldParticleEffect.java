...
public class SquareFieldParticleEffect extends AbstractCustomizableParticleEffect {
    public static final MapCodec<SquareFieldParticleEffect> CODEC = RecordCodecBuilder.mapCodec(
    ...
    public static final StreamCodec<ByteBuf, SquareFieldParticleEffect> STREAM_CODEC = composite(
    ...
    public SquareFieldParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed, int lifetime, float friction) {
