...
public class RuneParticleEffect extends AbstractCustomizableParticleEffect {
    public static final MapCodec<RuneParticleEffect> CODEC = RecordCodecBuilder.mapCodec(
    ...
    public static final StreamCodec<ByteBuf, RuneParticleEffect> STREAM_CODEC = composite(
    ...
    public RuneParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed, int lifetime, float friction) {
