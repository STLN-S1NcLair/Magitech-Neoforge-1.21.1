package net.stln.magitech.effect.visual.particle.particle_option;
...
public class SquareNoCullParticleEffect extends AbstractCustomizableParticleEffect {
    public static final MapCodec<SquareNoCullParticleEffect> CODEC = RecordCodecBuilder.mapCodec(
    ...
    public static final StreamCodec<ByteBuf, SquareNoCullParticleEffect> STREAM_CODEC = composite(
    ...
    public SquareNoCullParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed, int lifetime, float friction) {
