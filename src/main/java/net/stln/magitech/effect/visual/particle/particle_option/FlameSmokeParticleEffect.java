...
public class FlameSmokeParticleEffect extends AbstractCustomizableParticleEffect {
    public static final MapCodec<FlameSmokeParticleEffect> CODEC = RecordCodecBuilder.mapCodec(
    ...
    public static final StreamCodec<ByteBuf, FlameSmokeParticleEffect> STREAM_CODEC = composite(
    ...
    public FlameSmokeParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed, int lifetime, float friction) {
