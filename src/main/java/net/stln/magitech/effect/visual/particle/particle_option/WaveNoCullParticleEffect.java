...
public class WaveNoCullParticleEffect extends AbstractCustomizableParticleEffect {
    public static final MapCodec<WaveNoCullParticleEffect> CODEC = RecordCodecBuilder.mapCodec(
    ...
    public static final StreamCodec<ByteBuf, WaveNoCullParticleEffect> STREAM_CODEC = composite(
    ...
    public WaveNoCullParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed, int lifetime, float friction) {
