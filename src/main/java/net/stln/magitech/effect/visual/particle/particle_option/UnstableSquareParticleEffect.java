...
public class UnstableSquareParticleEffect extends AbstractCustomizableParticleEffect {
    ...
    public static final StreamCodec<ByteBuf, UnstableSquareParticleEffect> STREAM_CODEC = composite(
    ...
    public UnstableSquareParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed, int lifetime, float friction) {
