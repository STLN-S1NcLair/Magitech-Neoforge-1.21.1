...
public class SquareParticleEffect extends AbstractCustomizableParticleEffect {
    public static final MapCodec<SquareParticleEffect> CODEC = RecordCodecBuilder.mapCodec(
    ...
    public static final StreamCodec<ByteBuf, SquareParticleEffect> STREAM_CODEC = composite(
    ...
    public SquareParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed, int lifetime, float friction) {
