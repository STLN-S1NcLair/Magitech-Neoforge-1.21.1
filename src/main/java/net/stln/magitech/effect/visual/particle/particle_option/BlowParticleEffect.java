...
public class BlowParticleEffect extends AbstractCustomizableParticleEffect {
    public static final MapCodec<BlowParticleEffect> CODEC = RecordCodecBuilder.mapCodec(
    ...
    public static final StreamCodec<ByteBuf, BlowParticleEffect> STREAM_CODEC = composite(
    ...
    public BlowParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed, int lifetime, float friction) {
