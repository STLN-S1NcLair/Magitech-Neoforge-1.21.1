...
public class VoidGlowParticleEffect extends AbstractCustomizableParticleEffect {
    public static final MapCodec<VoidGlowParticleEffect> CODEC = RecordCodecBuilder.mapCodec(
    ...
    public static final StreamCodec<ByteBuf, VoidGlowParticleEffect> STREAM_CODEC = composite(
    ...
    public VoidGlowParticleEffect(Vector3f fromColor, Vector3f toColor, float scale, int twinkle, float rotSpeed, int lifetime, float friction) {
