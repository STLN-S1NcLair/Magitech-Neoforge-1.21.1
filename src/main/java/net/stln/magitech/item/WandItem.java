...
public class WandItem extends Item implements LeftClickOverrideItem {
    ...
    private void sweepAttack(Level world, Player user) {
        ...
        EffectUtil.sweepEffect(user, world, new UnstableSquareParticleEffect(new Vector3f(1.0F, 1.0F, 1.0F), new Vector3f(0.5F, 1.0F, 1.0F), 1.0F, 1), effectCenter, 45.0, -45.0, 100, 2, (user.getRandom().nextFloat() - 0.5) * 45.0);
