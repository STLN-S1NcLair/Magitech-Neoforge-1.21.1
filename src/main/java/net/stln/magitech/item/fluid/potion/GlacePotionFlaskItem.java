...
public class GlacePotionFlaskItem extends DrinkableFlaskItem {

    public GlacePotionFlaskItem(Properties properties) {
        super(properties);
    }
    ...
    protected void applyEffects(Level level, LivingEntity entity, ItemStack stack) {
        ...
        EffectUtil.entityEffect(level, new PowerupParticleEffect(new Vector3f(0.8F, 1.0F, 1.0F), new Vector3f(0.5F, 0.7F, 1.0F), 1F, 1, 0, 15, 1.0F), entity, 20);
    }
}
