...
public class MaterialInit {
    ...
    public static void registerMaterials() {
        ...
        STONE.addStats(ToolPart.SPIKE_HEAD  , new ToolStats(1.5F, 0.0F, -1.5F, 2.3F, 0.0F,  0.0F, 0.1F, 129, Element.NONE, MiningLevel.STONE));
        ...
        AMETHYST.addStats(ToolPart.HEAVY_BLADE , new ToolStats(4.3F, 0.6F, -1.6F, 1.8F, 0.8F, 0.1F, 1.8F, 206, Element.MAGIC, MiningLevel.STONE));
        ...
        TRANSLUCIUM.addStats(ToolPart.SPIKE_HEAD  , new ToolStats(1.7F, 1.1F, -1.4F, 6.1F, 0.0F,   0.0F, 0.5F, 1004, Element.PHANTOM, MiningLevel.NETHERITE));
