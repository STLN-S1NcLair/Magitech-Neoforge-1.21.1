        ...
        if (player.isCrouching()) {
            ...
            if (!list.isEmpty()) {
                ...
                if (item != null) {
                    ...
                    EffectUtil.lineEffect(level, new UnstableSquareParticleEffect(new Vector3f(0.0F, 1.0F, 0.8F), new Vector3f(0.0F, 1.0F, 0.8F), 1.0F, 4, 0, 15, 1.0F), playerPos, itemPos, 4, false);
