...
public class SpellConversionRecipe implements Recipe<SingleRecipeInput> {
    ...
    public SpellConversionRecipe(String group, Ingredient ingredient, Spell spell, ItemStack result) {
    ...
    public interface Factory<T extends SpellConversionRecipe> {
        T create(String group, Ingredient ingredient, Spell spell, ItemStack result);
    }
        ...
        protected Serializer(Factory<T> factory) {
            ...
            this.codec = RecordCodecBuilder.mapCodec(
                    p_340781_ -> p_340781_.group(
                                    ...
                                    Spell.CODEC.fieldOf("spell").forGetter(p_301068_ -> p_301068_.spell),
