...
public class TremivoxRenderer extends GeoEntityRenderer<TremivoxEntity> {
    ...
    @Override
    public @Nullable RenderType getRenderType(TremivoxEntity animatable, ResourceLocation texture, @Nullable MultiBufferSource bufferSource, float partialTick) {
        return RenderHelper.additiveNoCull(texture);
    }

    @Override
    protected void applyRotations(TremivoxEntity animatable, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick, float nativeScale) {
