...
public class IgniscaRenderer extends GeoEntityRenderer<IgniscaEntity> {
    ...
    @Override
    public @Nullable RenderType getRenderType(IgniscaEntity animatable, ResourceLocation texture, @Nullable MultiBufferSource bufferSource, float partialTick) {
        return RenderHelper.additiveNoCull(texture);
    }

    @Override
    protected void applyRotations(IgniscaEntity animatable, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick, float nativeScale) {
