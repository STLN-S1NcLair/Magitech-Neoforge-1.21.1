...
public class MirazienRenderer extends GeoEntityRenderer<MirazienEntity> {
    ...
    @Override
    public @Nullable RenderType getRenderType(MirazienEntity animatable, ResourceLocation texture, @Nullable MultiBufferSource bufferSource, float partialTick) {
        return RenderHelper.additiveNoCull(texture);
    }

    @Override
    protected void applyRotations(MirazienEntity animatable, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick, float nativeScale) {
