...
public class VolkarinRenderer extends GeoEntityRenderer<VolkarinEntity> {
    ...
    @Override
    protected void applyRotations(VolkarinEntity animatable, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick, float nativeScale) {
